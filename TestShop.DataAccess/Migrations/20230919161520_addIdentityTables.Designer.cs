...
namespace TestShop.DataAccess.Migrations
{
    ...
    [Migration("20230919161520_addIdentityTables")]
            ...
            modelBuilder.Entity("TestShop.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 9, 19, 21, 15, 20, 172, DateTimeKind.Local).AddTicks(4933),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 9, 19, 21, 15, 20, 172, DateTimeKind.Local).AddTicks(4943),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 9, 19, 21, 15, 20, 172, DateTimeKind.Local).AddTicks(4944),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
