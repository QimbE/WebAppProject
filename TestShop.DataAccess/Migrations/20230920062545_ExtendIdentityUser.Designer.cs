...
namespace TestShop.DataAccess.Migrations
{
    ...
    [Migration("20230920062545_ExtendIdentityUser")]
            ...
            modelBuilder.Entity("TestShop.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 9, 20, 11, 25, 45, 728, DateTimeKind.Local).AddTicks(5233),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 9, 20, 11, 25, 45, 728, DateTimeKind.Local).AddTicks(5242),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 9, 20, 11, 25, 45, 728, DateTimeKind.Local).AddTicks(5243),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
