...
namespace TestShop.DataAccess.Migrations
{
    ...
    [Migration("20230924083110_addCompanyToUser")]
            ...
            modelBuilder.Entity("TestShop.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDateTime = new DateTime(2023, 9, 24, 13, 31, 9, 979, DateTimeKind.Local).AddTicks(5261),
                            DisplayOrder = 1,
                            Name = "Action"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDateTime = new DateTime(2023, 9, 24, 13, 31, 9, 979, DateTimeKind.Local).AddTicks(5276),
                            DisplayOrder = 2,
                            Name = "SciFi"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDateTime = new DateTime(2023, 9, 24, 13, 31, 9, 979, DateTimeKind.Local).AddTicks(5277),
                            DisplayOrder = 3,
                            Name = "History"
                        });
                });
