...
namespace TestShopProject.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
	        IEnumerable<Product> productList = await _unitOfWork.Product.GetAll(includeProperties:"ProductImages");
        ...
        public async Task<IActionResult> Details(int id)
        {
	        ...
	        {
		        Product = await _unitOfWork.Product.Get(x => x.Id == id, "Categories,ProductImages"),
                Count = 1,
                ProductId = id
	        };
	        return View(cart);
